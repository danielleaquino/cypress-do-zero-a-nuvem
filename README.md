...
> I've used versions `2.45.2`, `v22.12.0` and `10.9.2` of git, Node.js and npm, respectively. I suggest you use the same or later LTS versions.
...
This project was created with 💚 by [Danielle Aquino](https://www.linkedin.com/in/danielle-aquino-3b1b97111/).
